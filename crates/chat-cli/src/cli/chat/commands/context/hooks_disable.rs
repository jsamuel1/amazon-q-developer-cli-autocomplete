...
/// Static instance of the disable hooks command handler
pub static DISABLE_HOOKS_HANDLER: DisableHooksCommand = DisableHooksCommand;

/// Handler for the context hooks disable command
pub struct DisableHooksCommand;

impl CommandHandler for DisableHooksCommand {
    ...
    fn help(&self) -> String {
        "Disable an existing context hook. Use --global to disable a global hook.".to_string()
    }
    ...
    fn to_command(&self, args: Vec<&str>) -> Result<crate::cli::chat::command::Command, ChatError> {
        ...
        Ok(crate::cli::chat::command::Command::Context {
            subcommand: crate::cli::chat::command::ContextSubcommand::Hooks {
                subcommand: Some(crate::cli::chat::command::HooksSubcommand::Disable { name, global }),
            },
        })
    }
